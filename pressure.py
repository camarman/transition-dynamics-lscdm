...
ax0.plot(a_vals, pressure_lscdm_vals_1,  color='red', ls='-', lw=3.0, label=r'$\sigma=50$')
ax0.plot(a_vals, pressure_lscdm_vals_2,  color='blue', ls='-', lw=3.0, label=r'$\sigma=100$')
ax0.plot(a_vals, pressure_lscdm_vals_3,  color='orange', ls='-', lw=3.0, label=r'$\sigma=200$')
ax0.plot(a_vals, pressure_lscdm_vals_4,  color='black', ls='-', lw=3.0, label=r'$\sigma \rightarrow \infty$')
...
# Tick options
ax0.set_xticks([0.275, 0.300, 0.325, 0.350, 0.375,
                0.400, 0.425, 0.450, 0.475])
ax0.set_yticks([1, 0, -1, -5, -10, -15, -20, -25])
